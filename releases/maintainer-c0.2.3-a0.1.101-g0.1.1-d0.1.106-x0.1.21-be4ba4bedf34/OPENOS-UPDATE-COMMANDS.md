...
Use this sheet only for release `maintainer-c0.2.3-a0.1.101-g0.1.1-d0.1.106-x0.1.21-be4ba4bedf34`. The four public artifacts were verified byte-for-byte at the immutable public commit below.

- Release: `maintainer-c0.2.3-a0.1.101-g0.1.1-d0.1.106-x0.1.21-be4ba4bedf34`
- Public repository: `SirJamesK/opencomputers-maintainer-releases`
- Public commit: `40b839c8c143066932a760a99a8394f095bb3eef`
- Private source commit: `d6153e1f456cf6be7021f2ed1538f98bee0ec25a`
...
```sh
wget -f https://raw.githubusercontent.com/SirJamesK/opencomputers-maintainer-releases/40b839c8c143066932a760a99a8394f095bb3eef/releases/maintainer-c0.2.3-a0.1.101-g0.1.1-d0.1.106-x0.1.21-be4ba4bedf34/install.lua /home/oc-release.lua
lua /home/oc-release.lua plan
lua /home/oc-release.lua status
lua /home/oc-release.lua stage https://raw.githubusercontent.com/SirJamesK/opencomputers-maintainer-releases/40b839c8c143066932a760a99a8394f095bb3eef/releases/maintainer-c0.2.3-a0.1.101-g0.1.1-d0.1.106-x0.1.21-be4ba4bedf34/bundle.ocb NO_BACKUP
lua /home/oc-release.lua status
```
...
exception excludes an eligible row. The active Fluid Stock canary is dynamically forced `SYSTEM OFF`,
...
tagged, ambiguous, malformed, legacy-fluid-proxy, and active-canary rows remain
...
and neither media kind requires a profile rewrite, seed craft, or new epoch. If
the active canary loses its
...
and `release=maintainer-c0.2.3-a0.1.101-g0.1.1-d0.1.106-x0.1.21-be4ba4bedf34`; that release must be the Lua inventory's `KEEP`
