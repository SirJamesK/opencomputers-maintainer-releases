...
local EXPECTED_RELEASE = "maintainer-c0.2.3-a0.1.100-g0.1.1-d0.1.105-x0.1.21-862a5d717876"
local EXPECTED_BUNDLE_SHA256 = "d60d69a1cc7cb8c00acfb45bc2c1d6c4ea73912185c6424930a5ffae9f6223de"
local EXPECTED_FILE_COUNT = 264
local EXPECTED_TARGET_CONTRACT_SHA256 = "fcb0bf62cf7298b2a2d5b141d640573338b032b4487352294154eb887a8c887e"
local EXPECTED_PERSISTED_MANIFEST_SHA256 = "ae0f01f07ae601a2f6493b3f7af979f8468c28c55c0c6e76395a107b0bea88be"
...
local function requestPostInstallConvergence(commissioning, lease)
  local called, ok, reason, status = pcall(commissioning.request,
    { source = "release_finalize", migrationLease = lease })
...
local function finishPostInstall()
  ...
  local called, ok, reason = xpcall(function()
    ...
    local requested, requestReason = requestPostInstallConvergence(
      commissioning, lease)
