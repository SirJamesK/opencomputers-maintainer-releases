...
local EXPECTED_RELEASE = "maintainer-c0.1.2-a0.1.56-g0.1.0-d0.1.58-x0.1.8-1ab196d99adb"
local EXPECTED_BUNDLE_SHA256 = "be5f9a44c8b6f3af75518fea5e032c5e483538eb5f058fdfb6543190a15258f7"
...
local EXPECTED_PERSISTED_MANIFEST_SHA256 = "6b37649552d6f16ce92b3fa793e0b363a917f40be552f27a05d32915758df043"
...
local function inventoryAndPreflight(entries)
  ...
  for index, entry in ipairs(entries) do
    ...
    checked(proxy and type(proxy.spaceTotal) == "function" and type(proxy.spaceUsed) == "function", "cannot inspect target filesystem: " .. entry.target)
    local key = tostring(proxy.address or proxy)
