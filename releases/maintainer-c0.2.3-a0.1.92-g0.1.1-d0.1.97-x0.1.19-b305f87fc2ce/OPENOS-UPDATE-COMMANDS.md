...
Use this sheet only for release `maintainer-c0.2.3-a0.1.92-g0.1.1-d0.1.97-x0.1.19-b305f87fc2ce`. The four public artifacts were verified byte-for-byte at the immutable public commit below.

- Release: `maintainer-c0.2.3-a0.1.92-g0.1.1-d0.1.97-x0.1.19-b305f87fc2ce`
- Public repository: `SirJamesK/opencomputers-maintainer-releases`
- Public commit: `5242ed59c74d0a1811fa3ace4672c35fb9b3631d`
- Private source commit: `7b683a9c3774d04c84f6696e48949a608cddfe82`
...
```sh
wget -f https://raw.githubusercontent.com/SirJamesK/opencomputers-maintainer-releases/5242ed59c74d0a1811fa3ace4672c35fb9b3631d/releases/maintainer-c0.2.3-a0.1.92-g0.1.1-d0.1.97-x0.1.19-b305f87fc2ce/install.lua /home/oc-release.lua
lua /home/oc-release.lua plan
lua /home/oc-release.lua status
lua /home/oc-release.lua stage https://raw.githubusercontent.com/SirJamesK/opencomputers-maintainer-releases/5242ed59c74d0a1811fa3ace4672c35fb9b3631d/releases/maintainer-c0.2.3-a0.1.92-g0.1.1-d0.1.97-x0.1.19-b305f87fc2ce/bundle.ocb NO_BACKUP
lua /home/oc-release.lua status
```
...
successful migration, or boot may already show Starting or Online; in either
case only observe. Otherwise press the visible **Start 2.8.4 Fluids**, or after
correcting its exact blocker **Retry 2.8.4 Fluids**, once. That is the one
required action: it durably saves the complete Fluid Autopilot intent before
returning, and the AE2 RC service continues every remaining phase. The Dashboard
may then close without pausing setup.
...
drifted state changes that same single control to **Retry 2.8.4 Fluids**; correct
the reported external condition and press it once. There is no second Configure,
Attest, profile-selection, Global Auto, row-arming, or final-enable action.
...
2. To repair one old, incomplete, or drifted workflow identity, open that
   ...
   executing in external machines.
...
invariant: correct the reported deployment condition, then press the visible
**Start 2.8.4 Fluids** or **Retry 2.8.4 Fluids** once to generate the next
`AUTO-Rn` and restore operation. Never enable
