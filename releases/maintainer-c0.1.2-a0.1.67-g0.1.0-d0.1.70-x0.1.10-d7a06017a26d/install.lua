...
local EXPECTED_RELEASE = "maintainer-c0.1.2-a0.1.67-g0.1.0-d0.1.70-x0.1.10-d7a06017a26d"
local EXPECTED_BUNDLE_SHA256 = "96d897577837de639e616518671cb56ef03d45b5b7561d24d9ed1835305c2b38"
local EXPECTED_FILE_COUNT = 178
local EXPECTED_TARGET_CONTRACT_SHA256 = "21a7b4e0251f841a052a64b0111f6195ce60f587d1e300687cf4c047ab1f3e2e"
local EXPECTED_PERSISTED_MANIFEST_SHA256 = "4a906456adf0614b36433dde57e756d817041906162b96fe1f247a36b8c7a2c5"
...
local function stage(url, backupAcknowledgement)
  ...
  return true, "STAGED: " .. tostring(EXPECTED_FILE_COUNT)
    .. " files verified; live targets unchanged; run shutdown, wait until visibly OFF, then power on manually"
end
...
local function applyRelease(offline, backup, confirmation)
  ...
  return true, "APPLIED: all " .. tostring(EXPECTED_FILE_COUNT)
    .. " live hashes verified; Maintainer remains OFF; full shutdown + manual power-on is required before rollback or finalize"
end
