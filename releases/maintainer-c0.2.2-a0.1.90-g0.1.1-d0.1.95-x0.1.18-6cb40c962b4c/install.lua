...
local EXPECTED_RELEASE = "maintainer-c0.2.2-a0.1.90-g0.1.1-d0.1.95-x0.1.18-6cb40c962b4c"
local EXPECTED_BUNDLE_SHA256 = "2bd9fd64e85d4fcc4e2ab16a1df1617c9e5dee03a9b6f606e1eacd2d63d1605f"
local EXPECTED_FILE_COUNT = 236
local EXPECTED_TARGET_CONTRACT_SHA256 = "54a7b39ef9a36c32f33ac18534fb0baf04649862957a79226cd538572defce92"
local EXPECTED_PERSISTED_MANIFEST_SHA256 = "a9dad1de51b8b7c49511a3608f2cf3b67ca2ac6db8b9560899cb29f4ca13b6c6"
...
local function daemonIsOff(allowInhibitedDesired)
  ...
  if chunk then
    ...
    if ok and type(value) == "table" and value.enabled == true then
...
local function phaseActions(state)
...
local function status()
  ...
  local nextAction, cancelAction = phaseActions(state)
  return true, table.concat({
    "release: " .. EXPECTED_RELEASE,
...
function api.run(command, ...)
  ...
  return nil, "usage: plan | status | next ... | cancel ... | stage <https-url> NO_BACKUP | apply OFFLINE NO_BACKUP CONFIRM | rollback OFFLINE NO_BACKUP CONFIRM | discard NO_BACKUP CONFIRM | finalize NO_BACKUP VERIFIED CONFIRM | unlock NO_BACKUP CONFIRM"
end
